                ...
                <div class="card-body">
                    <form method="POST" action="{{  route('admin.people.update', $person)  }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bio" type="text" class="form-control @error('bio') is-invalid @enderror" name="bio" value="{{ old('bio') ?? $person->bio }}" autocomplete="bio" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="personnalpage" class="col-md-4 col-form-label text-md-right">{{ __('Web page') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="picture" type="file" class="form-control @error('picture') is-invalid @enderror" name="picture" value="{{ old('picture') ?? $person->picture }}" autocomplete="picture" autofocus>
