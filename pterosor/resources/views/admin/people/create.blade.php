                ...
                <div class="card-body">
                    <form method="POST" action="{{  route('admin.people.store')  }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="personnalpage" type="text" class="form-control @error('personnalpage') is-invalid @enderror" name="personnalpage" value="{{ old('personnalpage') }}" autocomplete="personnalpage" autofocus>
